...
function setupGarden(){
  ...
  squirrel.push(new Squirrel({x:100, y:220}, 100, 'brown', squirrelImages));
  squirrel.push(new Squirrel({x:300, y:230}, 160, 'grey', squirrelImages));
  squirrel.push(new Squirrel({x:500, y:200}, 300, 'red', squirrelRunImgs));
  squirrel.push(new Squirrel({x:200, y:260}, 180, 'black', squirrelImages));
  squirrel.push(new Squirrel({x:700, y:260}, 200,'white', squirrelRunImgs));
 
  squirrel.forEach(squirrel => squirrel.renderSquirrel());

  squirrel.forEach(squirrel =>squirrel.animateSquirrel());
